...
@section('title', 'Услуги, оказываемые ООО «КБ 911»')
        ...
        <div class="container">
            ...
            <div class="row align-items-center flex-row-reverse">
                <div class="col-lg-6">
                    <div class="about_content pl-0 wow fadeInRight">
                        ...
                        <ul>
                            ...
                            <li>
                                Закон Российской Федерации от 03.07.2016 г. №230-ФЗ «О защите прав и законных интересов.
                ...
                <div class="col-lg-6 wow fadeInLeft">
                    <img class="img-fluid" src="{{ asset('storage/services/services1_850x852.jpg') }}" alt=""/>
                </div>
            </div>
