            ...
            <div class="row align-items-center flex-row-reverse">
                <div class="col-lg-6">
                    <div class="about_content pl-0 wow fadeInLeft">
                        ...
                        <p>
                            ООО ПКО «КБ911» независимое коллекторское агентство, работающее с дебиторской задолженностью
                        ...
                        <p>
                            ООО ПКО «КБ911» независимое коллекторское агентство, работающее с дебиторской задолженностью
                            граждан и организаций с 2011 года. ООО ПКО «КБ911» независимое коллекторское агентство,
