    ...
    <footer class="footer_area">
        ...
        <div class="footer_bottom">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-5">
                        <p>
                            ...
                            <a href="https://0b1101.ru"> YoStudio</a>. All Rights Reserved.
                        </p>
                    </div>
                ...
                <div class="row">
                    <p style="font-size: 0.8em;">ООО профессиональная коллекторская организация «Коллекторское бюро 911»
                        является оператором по обработке
